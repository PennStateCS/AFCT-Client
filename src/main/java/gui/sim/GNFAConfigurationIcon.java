 ...
 */
public class GNFAConfigurationIcon extends ConfigurationIcon {
    /**
     * Instantiates a new <CODE>ConfigurationIcon</CODE>.
     *
     * @param configuration
     *            the GNFA configuration that is represented
     */
    public GNFAConfigurationIcon(Configuration configuration) {
        super(configuration);
    }
    ...
    public void paintConfiguration(Component c, Graphics2D g, int width,
        ...
        GNFAConfiguration config = (GNFAConfiguration) getConfiguration();
