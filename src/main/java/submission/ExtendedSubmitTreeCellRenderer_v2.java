 ...
 */
public class ExtendedSubmitTreeCellRenderer_v2 implements TreeCellRenderer {
    ...
    public final JLabel mainLabel = new JLabel();
    public final PillRenderer subLabel = new PillRenderer();

    public ExtendedSubmitTreeCellRenderer_v2() {
...
//        panel.setOpaque(false);
    ...
    public Component getTreeCellRendererComponent(JTree tree, Object value,
        ...
        // Handle selection background colors properly
//        if (sel) {
//            panel.setBackground(tree.getSelectionBackground());
//            mainLabel.setForeground(tree.getSelectionForeground());
//            panel.setOpaque(true);
//        } else {
//            panel.setOpaque(false);
//            mainLabel.setForeground(tree.getForeground());
//        }
